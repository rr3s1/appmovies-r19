<div align="center">
  ...
  <h3 align="center">A Movie Application</h3>
   ...
   <div align="center">
     In this project I am coding along with Adrian Hajdin from JavaScript Mastery (YouTube) to develop a Movie Application by using React19. 
...
This repository contains the code corresponding to an in-depth tutorial available on JavaScript Mastery on YouTube, <a href="https://www.youtube.com/@javascriptmastery/videos" target="_blank"><b>JavaScript Mastery</b></a>.
...
```bash
git clone https://github.com/rr3s1/appmovies-r19.git
cd appmovies-r19
```
...
Enjoyed creating this project? Dive deeper into Adrian's PRO courses for a richer learning adventure. They're packed with
